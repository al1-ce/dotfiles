...
hi NormalBold      ctermfg=white      cterm=bold      guifg=#b9b9b9 gui=bold      guibg=#101010
hi Comment         ctermfg=darkgray   cterm=none      guifg=#6e6e6e gui=none      guibg=#101010
hi CursorLine      ctermfg=none       cterm=none                    gui=none      guibg=#101010
hi CursorLineNr    ctermfg=gray       cterm=none      guifg=#f7f7f7 gui=none      guibg=#101010
hi LineNr          ctermfg=gray       cterm=none      guifg=#b9b9b9 gui=none      guibg=#101010
hi Number          ctermfg=blue       cterm=none      guifg=#5f819d gui=bold      guibg=#101010
hi Boolean         ctermfg=blue       cterm=none      guifg=#5f819d gui=bold      guibg=#101010
hi Operator        ctermfg=white      cterm=bold      guifg=#b9b9b9 gui=bold      guibg=#101010
...
hi PmenuThumb      ctermfg=white      cterm=none      guifg=#b9b9b9 gui=none      guibg=#101010
hi SignColumn      ctermfg=darkgray   cterm=none      guifg=#8e8e8e gui=none      guibg=#101010
hi Special         ctermfg=darkyellow cterm=bold      guifg=#af8431 gui=bold      guibg=#101010
hi Statement       ctermfg=red        cterm=bold      guifg=#903a3a gui=bold      guibg=#101010
hi String          ctermfg=darkgreen  cterm=none      guifg=#9ca54e gui=none      guibg=#101010
hi Type            ctermfg=red        cterm=bold      guifg=#903a3a gui=bold      guibg=#101010
hi VertSplit       ctermfg=black      cterm=none      guifg=#101010 gui=none      guibg=#101010
hi Visual          ctermfg=none       cterm=reverse                 gui=reverse   guibg=#101010
...
hi DiagnosticUnderlineError term=underline cterm=underline gui=underline
